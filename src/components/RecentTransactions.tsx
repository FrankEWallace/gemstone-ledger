        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border text-left">
              <th className="pb-3 pr-4 text-xs font-medium uppercase tracking-widest text-muted-foreground">ID</th>
              <th className="pb-3 pr-4 text-xs font-medium uppercase tracking-widest text-muted-foreground">Description</th>
              <th className="pb-3 pr-4 text-xs font-medium uppercase tracking-widest text-muted-foreground hidden md:table-cell">Category</th>
              <th className="pb-3 pr-4 text-xs font-medium uppercase tracking-widest text-muted-foreground">Status</th>
              <th className="pb-3 pr-4 text-xs font-medium uppercase tracking-widest text-muted-foreground hidden lg:table-cell text-right">Qty</th>
              <th className="pb-3 pr-4 text-xs font-medium uppercase tracking-widest text-muted-foreground hidden lg:table-cell text-right">Unit Price</th>
              <th className="pb-3 text-xs font-medium uppercase tracking-widest text-muted-foreground text-right">Total</th>
            </tr>
          </thead>
          <tbody>
            {transactions.map((t) => {
