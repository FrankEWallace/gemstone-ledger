...
const DEC_ELECTRICITY = "dec6";
const DEC_PROCESSING  = "dec7";
const DIC_SALES      = "dic1";
const DIC_ROYALTIES  = "dic2";
const DIC_GRANTS     = "dic3";

// ─── Production Phase IDs ─────────────────────────────────────────────────────
export const DEMO_PHASE_ID_1 = "dp-phase1";
export const DEMO_PHASE_ID_2 = "dp-phase2";
...
export const DEMO_EXPENSE_CATEGORIES = [
  ...
  { id: DEC_ELECTRICITY, org_id: DEMO_ORG_ID, type: "expense" as const, name: "Electricity/Utilities",      description: "Grid power, generator fuel surcharge and other site utilities",                      color: "#0284c7", created_at: tsAgo(8760), updated_at: tsAgo(8760) },
  { id: DEC_PROCESSING,  org_id: DEMO_ORG_ID, type: "expense" as const, name: "Processing/Operating Costs", description: "Elution, ore/mineral processing days and general operating costs not covered elsewhere", color: "#65a30d", created_at: tsAgo(8760), updated_at: tsAgo(8760) },
];

// ─── Production Phases ────────────────────────────────────────────────────────

export const DEMO_PRODUCTION_PHASES = [
  {
    id: DEMO_PHASE_ID_1, site_id: DEMO_SITE_ID, org_id: DEMO_ORG_ID,
    name: "Awamu ya Kwanza (Phase 1)", status: "closed" as const,
    start_date: daysAgo(90), end_date: daysAgo(55),
    notes: "First production run — closed out.",
    created_at: tsAgo(2160), updated_at: tsAgo(1320),
  },
  {
    id: DEMO_PHASE_ID_2, site_id: DEMO_SITE_ID, org_id: DEMO_ORG_ID,
    name: "Awamu ya Pili (Phase 2)", status: "open" as const,
    start_date: daysAgo(43), end_date: null,
    notes: "Current production run.",
    created_at: tsAgo(1032), updated_at: tsAgo(24),
  },
];
